...
const Banner = () => {
    return (
        <div className='relative  lg:max-w-[1400] mx-auto '>
            ...
            <h1 className='font-bold top-30 left-1 text-2xl md:top-45 md:left-3 md:text-4xl lg:text-6xl absolute lg:top-52 lg:left-15 text-white'>Livestock Booking <br />Platform</h1>
